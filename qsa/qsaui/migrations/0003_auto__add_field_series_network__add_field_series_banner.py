...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Series.network'
        db.add_column(u'qsaui_series', 'network',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'Series.banner'
        db.add_column(u'qsaui_series', 'banner',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Series.network'
        db.delete_column(u'qsaui_series', 'network')

        # Deleting field 'Series.banner'
        db.delete_column(u'qsaui_series', 'banner')

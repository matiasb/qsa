...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Series.last_updated'
        db.add_column(u'qsaui_series', 'last_updated',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Series.last_updated'
        db.delete_column(u'qsaui_series', 'last_updated')
